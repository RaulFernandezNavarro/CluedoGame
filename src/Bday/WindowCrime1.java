...
public class WindowCrime1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WindowCrime1 frame = new WindowCrime1();
	...
	public WindowCrime1() {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(counter == 0) {
				CodeWindow CW6 = new CodeWindow("SOPHIE: Hey wowom, I found her phone on the floor. You can see it by writing : 'phone'.");
				CW6.setVisible(true);
				counter++;
			}
			//Get text
			...
			switch(txt) {
				...
				abrirarchivo("Extra/UnknownFP.jpg");
					CodeWindow CWV = new CodeWindow("SOPHIE: I found two different set of fingerprints. One belongs to the victim. Here's the other set :");
					CWV.setVisible(true);
