...
public class ScreensWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ScreensWindow frame = new ScreensWindow();
	...
	public ScreensWindow() {
		...
		//BTN DECLARATION -----------------------------------------------------------------------
		JButton ScreenBtn = new JButton("LAPTOP");
		ScreenBtn_1 = new JButton("PLANE TICKET");
		ScreenBtn_2 = new JButton("PHONE");
		ScreenBtn_3 = new JButton("HOME LAPTOP");
		ScreenBtn_4 = new JButton("DWAYNE'S ACCOUNT");
		...
		ScreenBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				abrirarchivo("Extra/Laptop_work.png");
			}
		});
		...
		ScreenBtn_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				abrirarchivo("Extra/DwayneAccounting.pdf");
			}
		});
		...
		textField.setBounds(207, 158, 101, 38);
		...
		//WALLPAPER-------------------------------------------------------------------------------
		ImageIcon icono = new ImageIcon("Extra/binarywallpaper.png");
